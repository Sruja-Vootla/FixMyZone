...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      await login(email, password); // async login from context
      navigate("/dashboard");
    } catch (err) {
    ...
    <div className="min-h-screen flex flex-col items-center justify-center">
      <div className="w-full max-w-md bg-white/15 backdrop-blur-md rounded-2xl shadow-lg border border-white/20 p-8 flex flex-col gap-6">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-200 text-sm">Welcome back, please log in.</p>
        </div>
        ...
        >
          ...
          <div className="flex w-80 items-center justify-between text-sm text-white">
